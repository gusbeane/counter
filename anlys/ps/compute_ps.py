...
if __name__ == '__main__':
    ...
    SMUGGLEproR2V6ang = 'SMUGGLE-flyby-R200-Vphi60-ang16-pro'
    SMUGGLEproR2V6M25 = 'SMUGGLE-flyby-R200-Vphi60-M25-pro'

    pair_list = [(Nbody, 'lvl4', 0), # 0
                 (Nbody, 'lvl3', 0), # 1
                 (SMUGGLE, 'lvl4', 0), # 2
                 (SMUGGLE, 'lvl3', 0), # 3
                 (SMUGGLEpro, 'lvl4', 0), # 4
                 (SMUGGLEproR2, 'lvl4', 0), # 5
                 (SMUGGLEproR2V6, 'lvl4', 0), # 6
                 (SMUGGLEproR2V6ang, 'lvl4', 16), # 7
                 (SMUGGLEproR2V6M25, 'lvl4', 0), # 8
                ]
